...
const EditSyndicModal: React.FC<EditSyndicModalProps> = ({
  isOpen,
  onClose,
  syndic,
}) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-card rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-border animate-in fade-in-0 zoom-in-95 duration-200">
        {/* Header */}
            ...
            <div className="flex items-center space-x-3 p-4 bg-muted/50 rounded-lg border border-border">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Deactivating will prevent the syndic from accessing the system
                </p>
              </div>
              <div
