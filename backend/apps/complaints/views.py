...
from .serializers import ReclamationSerializer, ResidentReclamationSerializer
from apps.users.permissions import IsSyndic, IsResident
from apps.users.models import Notification
from apps.apartments.models import Appartement
from .services.ai_triage import process_reclamation_ai
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        if reclamation.status != 'PENDING':
            return Response(
                {
                    'success': False,
                    'message': f"Cannot delete a complaint with status '{reclamation.status}'. Only PENDING complaints can be deleted.",
                },
